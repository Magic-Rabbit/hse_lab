...
public class PhoneLineSample extends javax.swing.JFrame {
    ...
    public PhoneLineSample() {
        ...
        _stateMap.put(PhoneLineContext.PhoneLineFSM.Ready, new Transition[] { _ready_validNumberTransition, _ready_invalidNumberTransition, _ready_onHookTransition });
        _stateMap.put(PhoneLineContext.PhoneLineFSM.Idle, new Transition[] { _idle_offHookTransition });
        _stateMap.put(PhoneLineContext.PhoneLineFSM.Warning, new Transition[] { _warning_invalidNumberTransition, _warning_validNumberTransition, _warning_onHookTransition });
